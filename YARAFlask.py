...
def trade_text():
    ...
    Dow_Jones = ['msi','aapl','pcln','dis','nflx','finish line','finl','intel','M80', 'motel', 'mattel', 'bss', 'dsx', 'vsx', 'psx', 'Boston Scientific', 'BB&T', 'a pa', 'apache',
                 ...
                 ' k', ' m', ' r',' ni']
    DJ_Name_Match = ['msi','aapl','pcln','dis','nflx','finl','finl','intc','mat', 'mat', 'mat', 'bsx', 'bsx', 'bsx', 'bsx', 'bsx', 'bbt', 'apa', 'apa', 'aal', 'aal', 'afl',
...
def analysis():
    ...
    if phrase1 == "":
        ...
        DJ_Name_Match = ['msi','aapl','pcln','dis','nflx','finl','finl','intc', 'mat', 'mat', 'mat', 'bsx', 'bsx', 'bsx', 'bsx', 'bsx', 'bbt', 'apa', 'apa', 'aal',
                         'aal', 'afl',
        ...
        Dow_Jones = ['msi','aapl','pcln','dis','nflx','finl','finish line','intel','M80', 'motel', 'mattel', 'bss', 'dsx', 'vsx', 'psx', 'Boston Scientific', 'BB&T', 'a pa',
                     ...
                     ' f', ' k', ' l', ' m', ' r',' ni',' ea']
        DJ_Name_Match = ['msi','aapl','pcln','dis','nflx','finl','finl','intc','mat', 'mat', 'mat', 'bsx', 'bsx', 'bsx', 'bsx', 'bsx', 'bbt', 'apa', 'apa', 'aal', 'aal',
        ...
        Dow_Jones = ['msi','aapl','pcln','dis','nflx','finl','finl','intel', 'M80', 'motel', 'mattel', 'bss', 'dsx', 'vsx', 'psx', 'Boston Scientific', 'BB&T', 'a pa',
                     'apache',
